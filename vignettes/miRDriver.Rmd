...
# <a id = " miRDriver at a glance"></a>  miRDriver at a glance
...
getRegionWiseGistic(gisticfile = system.file("extdata", "Dummy.gistic.lesions.txt", package="miRDriver"), gistic_bedfile = TRUE, mirdirectory=mirdirectory)
##Running the function.
getDifferentiallyExpressedGenes(RNACount = Dummy_RnaSeq_Count_Data, mirdirectory = mirdirectory)
###Load the necessary files.
load(file.path(mirdirectory, "mirDriverFold", "miRDriver_Step1", "GisticResults", "gistic_bedfile.rda"))
##Running the function.
makingCisAndTransGenes(Genes_coord_bedfile = Genes_coord, gistic_bedfile=region, mirdirectory=mirdirectory)
##Running the function.
gatherCisGenes(ncore = 2, mirna_bedfile=mirna_bedfile, gistic_bedfile=region, mirdirectory=mirdirectory)
##Running the function.
getTransGenePredictorFile(methylationData = dummy_methylationData10, RSeqData = dummy_RSeqData10_200, CNVData = dummy_CNVData10, TFData = dummy_TFData, mirnaData = dummy_mirnaData10, mirdirectory = mirdirectory)
##Running the function.
lassoParallelForTransGene(ncore = 2, numCounter = 10,Nfolds = 3,nonZeroPercent = 20, mirdirectory = mirdirectory)
##Showing final result.
load(file.path(mirdirectory, "miRDriverFold", "miRDriver_RESULTS", "LassoMinCoeff", "ENSG00000088387.Rda"))
min_Coeff[1:3,]
```
