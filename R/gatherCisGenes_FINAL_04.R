...
gatherCisGenes <-function(ncores = 2,mirna_bedfile,gistic_bedfile,parallel = c('TRUE', 'FALSE')) {
        ...
        processGeneFiles <- function(fileName) {
                cis_genes <- NULL
                tryCatch({
                        load(paste0("~/mirDriverFold/miRDriver_Step2/Trans_Cis_Files/",fileName,"/trans_genes.Rda"))
                        load(paste0("mirDriverFold/miRDriver_Step2/Trans_Cis_Files/",fileName,"/cis_genes.Rda"))
                        ...
                        if (nrow(cis_genes) == 0) {
                                ...
                                for (i in seq_along(trans_genes$gene_id))
                                {
                                        ...
                                        save(tc_de,file = paste0("mirDriverFold/miRDriver_Step3/transgene_w_DEcisgene/",fname,".Rda"))
                                }
                        }
                        return()
                }, error = function(error_condition) {
                        cat(paste0(fileName, " : ", error_condition),file = "mirDriverFold/ERROR_FILES/Step3_TransGene_w_all_cisgenes_from_all_regions.txt",sep = "\n",append = TRUE)
                        return()
                }, finally = {
                })
        }
        if (parallel == TRUE) {
                ...
                ###### MAIN PROGRAM############################################################
                fileNames <-list.files("mirDriverFold/miRDriver_Step2/Trans_Cis_Files/")
        ...
        fileList <-list.files("mirDriverFold/miRDriver_Step3/transgene_w_DEcisgene/",pattern = "*.Rda")
        ...
        #################
        current_folder <-"mirDriverFold/miRDriver_Step3/transgene_w_DEcisgene"
        fileList <-list.files("mirDriverFold/miRDriver_Step3/transgene_w_DEcisgene/",pattern = "*.Rda")
        for (i in seq_along(fileList)) {
                newlocation = unique(data.table(str_split_fixed(fileList[i],"_", 2))[,1])$V1
                new_folder <-paste0("mirDriverFold/miRDriver_Step3/DE_GCIS/", newlocation)
                file.move(file.path(current_folder, fileList[i]), new_folder)
        }
        ...
        processGM <- function(GeneFile) {
                tc_de <- NULL
                tryCatch({
                        file_list1 <-list.files(paste0("mirDriverFold/miRDriver_Step3/DE_GCIS/", GeneFile))
                        for (file in file_list1) {
                                load(paste0("mirDriverFold/miRDriver_Step3/DE_GCIS/",GeneFile,"/",file))
                        ...
                        TC <- unique(TC)
                        save(TC,file = paste0("mirDriverFold/miRDriver_Step3/gene_all_DEcis/",GeneFile,".Rda"))
                }, error = function(error_condition) {
                        cat(paste0(GeneFile, " : ", error_condition),file = "mirDriverFold/ERROR_FILES/Step3_TransGene_w_all_cisgenes_from_all_regions.txt",sep = "\n",append = TRUE)
                        return()
                }, finally = {
                })
        }
        if (parallel == TRUE) {
                ...
                ### MAIN FUNCTION###
                GeneFileList <-list.files("mirDriverFold/miRDriver_Step3/DE_GCIS")
        ...
        GeneFileList1 <-list.files("mirDriverFold/miRDriver_Step3/gene_all_DEcis")
        ##Code 4
        ...
        if (gistic_bedfile == FALSE) {
                ...
                region <- bedr.merge.region(region)
        ...
        overlapping_pairs <- bedr.join.region(mirna_bedfile,region,report.n.overlap = TRUE,check.chr = FALSE)
        ...
        {
                myfile <-file.path(paste0("mirDriverFold/miRDriver_Step3/miRNA_by_GisticRegion/",mirna_in_gistic_region[i, 1],".txt"))
        ...
        ## CODE 5:
        fileNamesMiRNA <-list.files("mirDriverFold/miRDriver_Step3/miRNA_by_GisticRegion/",pattern = "*.txt")
        processUpDownGeneFiles <- function(fileNames) {
                f<- NULL
                file_list1 <-list.files(paste0("mirDriverFold/miRDriver_Step3/DE_GCIS/", fileNames))
                gene <- fileNames
        for (i in seq_along(file_list1)) {
                ...
                {
                        RegionMiRna <-read.csv(paste0("mirDriverFold/miRDriver_Step3/miRNA_by_GisticRegion/",mirnafilename,sep = ""),sep = ";",header = FALSE)
                        ...
                        save( gm,file = paste0("~/mirDriverFold/miRDriver_Step3/Trans_Mirna_Files/",fname,".Rda")) 
        ...
        ##### MAIN PROGRAM############################################################
        ######################
        fileList <-list.files("mirDriverFold/miRDriver_Step3/DE_GCIS/")
        ...
        ## First Create the gene folders
        ## CODE START###
        fileList <-list.files("mirDriverFold/miRDriver_Step3/Trans_Mirna_Files/",pattern = "*.Rda")
        files <- data.table(fileList)
        files <- data.table(str_split_fixed(files$fileList, "_", 2))[,1,drop=FALSE]
        files <- unique(files)
        for (i in seq_along(files$V1)) {
        ...
        for (i in seq_along(fileList)) {
                newlocation = unique(data.table(str_split_fixed(fileList[i],"_", 2))[,1])$V1
                current_folder <-"mirDriverFold/miRDriver_Step3/Trans_Mirna_Files/"
                new_folder <-paste0("mirDriverFold/miRDriver_Step3/GMIRNA/", newlocation)
        ...
        processGM <- function(GeneFile) {
                tryCatch({
                        file_list1 <-list.files(paste0("mirDriverFold/miRDriver_Step3/GMIRNA/", GeneFile))
                        for (file in file_list1) {
                                load(paste0("mirDriverFold/miRDriver_Step3/GMIRNA/",GeneFile,"/",file))
                                gm <- data.table(t(gm))
                        ...
                        GM <- unique(GM)
                        save(GM,file = paste0("mirDriverFold/miRDriver_Step3/gene_all_mirna/",GeneFile,".Rda"))
                }, error = function(error_condition) {
                        cat(paste0(GeneFile, " : ", error_condition),file = "mirDriverFold/ERROR_FILES/Step3_TransGene_w_all_mirnagenes_from_all_regions.txt",sep = "\n",append = TRUE)
                        return()
                }, finally = {
                })
        }
        if (parallel == TRUE) {
                ...
                clusterExport(cl = cl, "processGM", envir = environment())
                ########### MAIN FUNCTION######################
                GeneFileList <-list.files("mirDriverFold/miRDriver_Step3/GMIRNA") 
                parLapply(cl, GeneFileList, processGM)
                stopCluster(cl)
        }
        if (parallel == FALSE) {
        ...
        ###End
        GeneFileList1 <-list.files("mirDriverFold/miRDriver_Step3/gene_all_mirna/") 
